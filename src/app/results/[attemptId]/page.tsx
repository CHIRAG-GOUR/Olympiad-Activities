...
export default function ExamResultScorePage({ params }: { params: Promise<{ attemptId: string }> }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F6F8FB] flex items-center justify-center p-6 font-sans">
        <div className="text-center space-y-3">
          <div className="w-10 h-10 border-4 border-[#2563A8] border-t-transparent rounded-full animate-spin mx-auto" />
  ...
  if (!attempt && !report) {
    return (
      <div className="min-h-screen bg-[#F6F8FB] flex items-center justify-center p-6 font-sans">
        <div className="bg-white border border-[#E3E8EF] rounded-2xl p-8 max-w-lg text-center space-y-4 shadow-sm">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 h-10 px-6 bg-[#2563A8] hover:bg-[#1B4E88] text-white rounded-xl text-xs font-bold shadow-subtle transition-all"
          >
  ...
  return (
    <div className="min-h-screen bg-[#F6F8FB] flex flex-col justify-between py-6 px-3 sm:px-6 lg:px-8 font-sans print:bg-white print:p-0 select-none text-[#172033]">
      {/* Top Action Bar */}
      <div className="max-w-5xl mx-auto w-full flex items-center justify-between text-xs text-[#667085] mb-5 print:hidden">
        <Link
          href="/"
          className="h-10 px-4 bg-white border border-[#E3E8EF] hover:bg-[#EAF2FB] text-[#172033] flex items-center gap-2 font-bold rounded-xl transition-colors shadow-subtle"
        >
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/admin/results"
            className="h-10 px-4 bg-white border border-[#E3E8EF] hover:bg-[#EAF2FB] text-[#2563A8] flex items-center gap-2 font-bold rounded-xl transition-colors shadow-subtle"
          >
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="h-10 px-5 bg-[#2563A8] hover:bg-[#1B4E88] text-white rounded-xl flex items-center gap-2 font-bold transition-all shadow-subtle cursor-pointer"
          >
      ...
      <main className="max-w-5xl mx-auto w-full space-y-6">
        ...
        <div className="bg-white border border-[#E3E8EF] rounded-3xl p-6 sm:p-10 shadow-sm relative overflow-hidden print:border-none print:shadow-none">
          {/* Header */}
          <div className="border-b border-[#E3E8EF] pb-6 text-center space-y-2">
            <div className="flex items-center justify-center gap-2">
              <span className="w-8 h-8 rounded-xl bg-[#2563A8] text-white flex items-center justify-center font-black text-sm">
                <ShieldCheck className="w-5 h-5 text-[#E0AE2B]" />
              </span>
              <span className="text-xs uppercase font-extrabold tracking-widest text-[#2563A8]">
            ...
            <div className="bg-[#F6F8FB] border border-[#E3E8EF] rounded-xl p-3.5 max-w-2xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-3 text-left mt-3">
              <div>
              ...
              <div>
                ...
                <strong className="text-xs font-mono font-bold text-[#2563A8] block">{studentId}</strong>
              </div>
              <div>
          ...
          <div className="py-6 flex flex-col items-center justify-center">
            <span className="text-[11px] uppercase font-black tracking-widest text-[#D9534F] mb-2">
          ...
          {/* Quick Metrics Strip */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto pt-4 border-t border-[#E3E8EF] text-center">
            <div className="bg-[#F6F8FB] border border-[#E3E8EF] rounded-xl p-3">
            ...
            <div className="bg-[#F6F8FB] border border-[#E3E8EF] rounded-xl p-3">
              ...
              <strong className="text-lg font-mono font-black text-[#2563A8] block">{accuracy}%</strong>
            </div>
            <div className="bg-[#F6F8FB] border border-[#E3E8EF] rounded-xl p-3">
        ...
        {topicResults.length > 0 && (
          <div className="bg-white border border-[#E3E8EF] rounded-3xl p-6 sm:p-8 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-[#E3E8EF] pb-3">
              <BarChart3 className="w-5 h-5 text-[#2563A8]" />
              <h2 className="text-base font-extrabold text-[#172033]">Topic-Wise Performance Breakdown</h2>
            </div>

            <div className="overflow-x-auto border border-[#E3E8EF] rounded-xl">
              <table className="w-full text-left text-xs font-semibold">
                ...
                <tbody className="divide-y divide-[#E3E8EF] text-[#172033]">
                  {topicResults.map((t, idx) => (
                    <tr key={idx} className="hover:bg-[#F6F8FB]/60">
                      ...
                      <td className="p-3 text-center font-mono font-bold text-[#2563A8]">
                        +{t.marksAwarded} / {t.maxMarks}
                      </td>
                      <td className="p-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <div className="w-16 bg-[#F6F8FB] border border-[#E3E8EF] h-2 rounded-full overflow-hidden">
                            <div
                              className={`h-full ${
        ...
        <div className="bg-white border border-[#E3E8EF] rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
          <div className="flex items-center justify-between border-b border-[#E3E8EF] pb-3">
            <div className="flex items-center gap-2">
              <Layers className="w-5 h-5 text-[#2563A8]" />
              ...
              questionResults.map((q) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-xs mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        {isCorrect ? (
                          ...
                          <span className="inline-flex items-center gap-1 text-[#667085] font-bold bg-[#EAF2FB] px-2 py-0.5 rounded-md text-[11px]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs bg-white p-3 rounded-xl border border-[#E3E8EF]">
                      <div>
                      ...
                      <div>
                        ...
                        <span className="font-bold font-mono text-[#2563A8]">{q.correctAnswerFormatted}</span>
                      </div>
                    </div>

                    {q.explanation && (
                      <div className="mt-2 text-[11px] text-[#667085] bg-[#F6F8FB] p-2.5 rounded-xl border border-[#E3E8EF]">
