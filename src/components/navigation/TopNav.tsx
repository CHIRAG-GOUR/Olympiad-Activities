...
import { Bell, ChevronDown, Menu, X, Check, LogOut, FlaskConical } from "lucide-react";

/**
 * Platform navigation.
 *
 * Entries are built from the active role's permissions rather than rendered and then
 * filtered, so a role is never offered a destination the guard would refuse. The role
 * switcher appears only for accounts entitled to more than one role.
 */
        ...
        <div className="h-16 flex items-center gap-3">
          <Link href={home} className="flex items-center gap-2.5 shrink-0 group">
            ...
            <span className="hidden sm:block leading-tight">
              ...
              <span className="block text-[11px] text-[#77839A] font-medium">
