    ...
    <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-700/80 rounded-xl p-6 text-white shadow-2xl space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="p-3.5 bg-slate-950/90 border border-slate-700 rounded-xl text-center space-y-1">
          <span className="text-xs font-mono text-slate-400">Person 1: Sneha</span>
          <div className="font-black text-lg text-sky-300">42.5 kg</div>
        </div>

        <div className="p-3.5 bg-slate-950/90 border border-slate-700 rounded-xl text-center space-y-1">
          <span className="text-xs font-mono text-slate-400">Person 2: Sakshi (+4.8kg)</span>
          <div className="font-black text-lg text-sky-300">47.3 kg</div>
        </div>

        <div className="p-3.5 bg-sky-950/60 border-2 border-sky-400 rounded-xl text-center space-y-1 shadow-lg shadow-sky-500/20">
          <span className="text-xs font-mono text-sky-300 font-bold">Person 3: Target</span>
