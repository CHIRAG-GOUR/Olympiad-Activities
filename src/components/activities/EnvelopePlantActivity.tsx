  ...
  return (
    <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 text-slate-900 shadow-sm space-y-6">
      ...
      <div className="p-6 bg-slate-50 border border-slate-200 border border-slate-200 rounded-xl flex items-center justify-around flex-wrap gap-4">
        ...
        <div className="p-3.5 bg-emerald-50 border border-emerald-200 border-2 border-emerald-400 rounded-xl text-center space-y-1 shadow-lg shadow-emerald-500/20">
