...
export function StepSyncActivity({
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-700/80 rounded-xl p-6 text-white shadow-2xl space-y-6">
      ...
      <div className="p-5 bg-slate-950/90 border border-slate-800 rounded-xl space-y-3">
        <div className="space-y-2">
          {/* Girl 1: 50 cm steps (9 steps to 450 cm) */}
          <div className="flex items-center gap-3">
            <span className="w-20 text-[11px] font-mono text-sky-400 font-bold">Girl 1 (50cm)</span>
            <div className="flex-1 h-3 bg-slate-900 border border-slate-700 rounded-full flex items-center justify-between px-1">
              {[0, 50, 100, 150, 200, 250, 300, 350, 400, 450].map((s) => (
                <span key={s} className="w-1.5 h-1.5 bg-sky-400 rounded-full" />
              ))}
            </div>
            <span className="text-[10px] font-mono text-slate-400">9 Steps</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono text-slate-400">6 Steps</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono text-slate-400">5 Steps</span>
          </div>
        </div>

        {/* Alignment Flag Banner */}
        <div className="pt-2 border-t border-slate-800 text-center text-xs font-mono text-emerald-400 font-bold">
