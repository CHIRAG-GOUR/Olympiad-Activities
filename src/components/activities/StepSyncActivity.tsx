...
export function StepSyncActivity({
  value,
  onChange,
  readOnly = false }: StepSyncActivityProps) {
    ...
    <div className="bg-white border-2 border-slate-200 rounded-2xl p-4 text-slate-900 shadow-sm space-y-3.5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-lg text-emerald-700 flex items-center gap-2">
              Step Synchronizer (LCM Alignment) 
            </h3>
            <p className="text-xs text-slate-600">
              Three walkers take steps of <strong className="text-slate-900">50 cm</strong>, <strong className="text-slate-900">75 cm</strong>, and <strong className="text-slate-900">90 cm</strong>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5 bg-slate-50 border border-slate-200 rounded-xl space-y-3">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3">
            <span className="w-20 text-[11px] font-mono text-sky-800 font-bold">Girl 1 (50cm)</span>
            <div className="flex-1 h-3 bg-white border border-slate-200 rounded-full flex items-center justify-between px-1">
          ...
          <div className="flex items-center gap-3">
            <span className="w-20 text-[11px] font-mono text-emerald-700 font-bold">Girl 2 (75cm)</span>
            <div className="flex-1 h-3 bg-white border border-slate-200 rounded-full flex items-center justify-between px-1">
          ...
          <div className="flex items-center gap-3">
            <span className="w-20 text-[11px] font-mono text-amber-800 font-bold">Girl 3 (90cm)</span>
            <div className="flex-1 h-3 bg-white border border-slate-200 rounded-full flex items-center justify-between px-1">
        ...
        <div className="pt-2 border-t border-slate-200 text-center text-xs font-mono text-emerald-700 font-bold">
