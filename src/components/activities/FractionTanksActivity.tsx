...
export function FractionTanksActivity({
  value,
  onChange,
  readOnly = false }: FractionTanksActivityProps) {
  ...
  return (
    <div className="bg-white border-2 border-slate-200 rounded-2xl p-4 text-slate-900 shadow-sm space-y-3.5">
      ...
      <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-center gap-8 flex-wrap">
