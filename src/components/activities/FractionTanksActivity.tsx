...
export function FractionTanksActivity({
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-700/80 rounded-xl p-6 text-white shadow-2xl space-y-6">
      ...
      <div className="p-6 bg-slate-950/90 border border-slate-800 rounded-xl flex items-center justify-center gap-8 flex-wrap">
        {/* Tank P: 4 out of 8 bars filled */}
        <div className="flex flex-col items-center gap-2">
          <div className="w-24 h-40 bg-slate-900 border-2 border-cyan-500/60 rounded-xl relative overflow-hidden flex flex-col-reverse p-1">
          ...
          <span className="font-bold text-sm text-cyan-300">Tank P (4/8 = 1/2)</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="font-bold text-sm text-cyan-300">Tank Q (3/6 = 1/2)</span>
        </div>
      </div>
