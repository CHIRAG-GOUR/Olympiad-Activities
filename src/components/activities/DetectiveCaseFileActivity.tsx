...
export function DetectiveCaseFileActivity({
  ...
  return (
    <div className="bg-white border-2 border-slate-200 rounded-2xl p-4 text-slate-900 shadow-sm space-y-3.5">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-2 ${
            activeLayer === "perimeter"
              ...
              : "bg-white border border-slate-200 text-slate-600 hover:text-slate-800 border border-slate-200"
          }`}
        >
      ...
      <div className="space-y-2">
        <div className="text-xs font-semibold text-slate-600 uppercase tracking-wider">Select Verified Measurement Pair:</div>
