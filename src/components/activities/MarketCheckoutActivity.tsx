  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-700/80 rounded-xl p-6 text-white shadow-2xl space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="p-3.5 bg-slate-950/90 border border-slate-700 rounded-xl text-center space-y-1">
          <span className="text-2xl">🍎</span>
          <div className="font-mono font-black text-lg text-amber-300">XLV Apples</div>
          <span className="text-[10px] text-slate-400 font-mono">= 45 units</span>
        </div>

        <div className="p-3.5 bg-slate-950/90 border border-slate-700 rounded-xl text-center space-y-1">
          <span className="text-2xl">🍊</span>
          <div className="font-mono font-black text-lg text-amber-300">XXVIII Oranges</div>
          <span className="text-[10px] text-slate-400 font-mono">= 28 units</span>
        </div>

        <div className="p-3.5 bg-slate-950/90 border border-slate-700 rounded-xl text-center space-y-1">
          <span className="text-2xl">🍉</span>
          <div className="font-mono font-black text-lg text-amber-300">XIV Melons</div>
          <span className="text-[10px] text-slate-400 font-mono">= 14 units</span>
        </div>
      </div>
          ...
          {options.map((opt) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] text-slate-400 mt-2 font-mono">Option {opt.id} ({opt.num})</span>
              </button>
            );
          })}
        </div>
