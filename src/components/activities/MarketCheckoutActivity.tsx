...
export function MarketCheckoutActivity({
  value,
  onChange,
  readOnly = false }: MarketCheckoutActivityProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-lg text-amber-700 flex items-center gap-2">
              Ancient Market Checkout 
            </h3>
            <p className="text-xs text-slate-600">
              Checkout register: Add <strong className="text-slate-900">XLV Apples</strong> + <strong className="text-slate-900">XXVIII Oranges</strong> + <strong className="text-slate-900">XIV Watermelons</strong>.
            </p>
          </div>
        </div>
      </div>
