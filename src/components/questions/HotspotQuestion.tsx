      ...
      <div className="relative w-full max-w-3xl mx-auto bg-[#FFFDF5] border-2 border-[#FDE68A] rounded-2xl p-6 shadow-md select-none">
        <div className="relative w-full aspect-[16/9] bg-[#FEFCE8] rounded-xl border-2 border-[#FDE68A] flex items-center justify-center overflow-hidden">
          <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            <line x1="20" y1="75" x2="80" y2="75" stroke="#0B4F8A" strokeWidth="2.2" />

            <path d="M 44,36 A 12,12 0 0,0 58,35" fill="none" stroke="#C62828" strokeWidth="1.5" />
            <text x="46" y="19" fontSize="5" fill="#0B4F8A" fontWeight="900">
              Vertex B (125°)
            </text>
            <text x="12" y="83" fontSize="5" fill="#0B4F8A" fontWeight="900">
              Vertex A (50°)
            </text>
            <text x="82" y="83" fontSize="5" fill="#0B4F8A" fontWeight="900">
              Vertex C (65°)
            </text>
            ...
            return (
              <button
                ...
                className={`absolute w-12 h-12 rounded-full flex items-center justify-center transition-all cursor-pointer ${
                  isSelected
                    ? "bg-[#C62828] text-white ring-6 ring-rose-200 shadow-xl scale-125 z-20"
                    : "bg-white border-3 border-[#F59E0B] text-[#D97706] hover:bg-[#0B4F8A] hover:text-white shadow-md hover:scale-110 z-10"
                }`}
