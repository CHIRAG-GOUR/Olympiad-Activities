            ...
            return (
              <button
                ...
                className={`w-full text-left px-5 h-[56px] rounded-xl border-2 transition-all flex items-center justify-between text-[15px] font-bold shadow-subtle ${
                  isSelected
                    ? "border-[#F59E0B] bg-[#2563A8] text-white shadow-md scale-[1.02]"
                    : isPaired
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {isPaired && !isSelected && (
                    <span className="w-5 h-5 rounded-full bg-[#2563A8] text-white flex items-center justify-center text-xs font-bold">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <span
                    className={`w-3.5 h-3.5 rounded-full border-2 ${
                      isPaired ? "border-[#2563A8] bg-[#2563A8]" : "border-[#FDE68A]"
                    }`}
                  />
                  <div>{item.text}</div>
                </div>
