...
async function main() {
  ...
  await writeDoc(idToken, "exams", examDoc.id, examDoc);
  console.log("  Exam record created in Firestore.");

  console.log("\n  Seeding complete! Firestore database 'olympiad' is fully initialized.\n");
}
